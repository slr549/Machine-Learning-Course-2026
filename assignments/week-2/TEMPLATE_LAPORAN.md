...
* **Nama:** [Isi Nama Anda]
* **NIM:** [Isi NIM Anda]
* **Link W&B Project:** [Paste Link Dashboard W&B Anda di sini]
...
1. Isi template ini dengan lengkap.
2. Ekspor menjadi **PDF** atau simpan sebagai **README.md** di dalam folder tugas Anda.
3. Pastikan notebook `.ipynb` Anda sudah dijalankan hingga selesai (*Run All*) sebelum dikumpulkan.
